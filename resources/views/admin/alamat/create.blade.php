                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            ...
                            id="alamat" type="text" name="alamat" rows="5" placeholder="isi alamat" required></textarea>
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="email" type="email" name="email" placeholder="isi email" required></input>
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="telepon" type="number" name="telepon" placeholder="isi telepon" required></input>
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="jam" type="text" name="jam" placeholder="isi jam kerja" required></input>
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="maps" type="text" name="maps" rows="5" placeholder="isi maps" required></textarea>
                    </label>
                    <br>
