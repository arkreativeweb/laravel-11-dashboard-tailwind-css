                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            ...
                            id="title" type="text" name="title" value="{{ $artikel->title }}" />
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="content" type="text" name="content" rows="10" placeholder="isi artikel disini"> {{ $artikel->content }}</textarea>
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="meta_deskripsi" type="text" name="meta_deskripsi" rows="5">{{ $artikel->meta_deskripsi }}</textarea>
                    </label>
                    <br>
                    <label class="block text-sm">
                        ...
                        <textarea
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="meta_keyword" type="text" name="meta_keyword" rows="5" placeholder="isi artikel disini">{{ $artikel->meta_keyword }}</textarea>
                    </label>
                    <br>
                    <label class="block text-sm">
                        <button
