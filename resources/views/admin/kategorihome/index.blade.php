    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="flex flex-col flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
                ...
                <a href="{{ route('admin.kategorihome.create') }}"
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('admin.kategorihome.edit', $item->id) }}"
                                            ...
                                            <a href="{{ route('admin.kategorihome.destroy', $item->id) }}"
                                            ...
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('admin.kategorihome.destroy', $item->id) }}"
                ...
                <div
                    ...
                    <span class="flex items-center col-span-3">
                        Showing {{ $kategori->firstItem() }}-{{ $kategori->lastItem() }} of
                        {{ $kategori->total() }}
                    </span>
