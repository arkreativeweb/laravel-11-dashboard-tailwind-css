<x-dashboard>
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <!-- General elements -->
            <form action="{{ route('admin.kategorihome.update', $kategori->id) }}" method="POST"
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Judul kategori</span>
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="judul" type="text" name="judul" value="{{ $kategori->judul }}" />
                    </label>
                    <br>
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            id="deskripsi" type="text" name="deskripsi" rows="10" placeholder="isi kategori disini"> {{ $kategori->deskripsi }}</textarea>
                    </label>
                    <br>
